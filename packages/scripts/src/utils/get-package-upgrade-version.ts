 ...
 * @最后修改时间: 2024-10-16 14:16:05
 * @项目的路径: \CMS-components\packages\scripts\src\utils\get-package-upgrade-version.ts
 * @描述: 获取包升级的版本号
 */
...
export default function (packageName) {
    ...
    console.success("完成--------------获取最新包-" + packageName + "的版本号:" + version);
    return version;
}
